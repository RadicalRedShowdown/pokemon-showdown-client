...
BattleMoveAnims['wavecrash'] = {anim: BattleMoveAnims['oceanicoperetta'].anim};
...
BattleMoveAnims['barbbarrage'] = {anim: BattleMoveAnims['maxooze'].anim};
BattleMoveAnims['esperwing'] = {anim: BattleMoveAnims['oblivionwing'].anim};
BattleMoveAnims['bittermalice'] = {anim: BattleMoveAnims['dragondarts'].anim};
BattleMoveAnims['shelter'] = {anim: BattleMoveAnims['coil'].anim};
...
BattleMoveAnims['springtidestorm'] = {anim: BattleMoveAnims['coreenforcer'].anim};
BattleMoveAnims['bleakwing'] = {anim: BattleMoveAnims['aeroblast'].anim};
BattleMoveAnims['wildboltstorm'] = {anim: BattleMoveAnims['thundercage'].anim};
BattleMoveAnims['sandsearstorm'] = {anim: BattleMoveAnims['splinteredstormshards'].anim};
BattleMoveAnims['lunarblessing'] = {anim: BattleMoveAnims['wish'].anim};
BattleMoveAnims['takeheart'] = {anim: BattleMoveAnims['heartstamp'].anim};
BattleMoveAnims['mysticalpower'] = {anim: BattleMoveAnims['clangoroussoulblaze'].anim};
