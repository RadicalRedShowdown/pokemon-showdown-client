...
export const BattleMoveAnims: AnimTable = {
	...
	sheercold: { // Reminder: Improve this later
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect(`url('http://${Config.routes.client}/sprites/gen6bgs/bg-icecave.jpg')`, 1000, 0.6);
			scene.showEffect('icicle', {
				x: defender.x,
				y: defender.y,
				z: defender.z,
	...
	plasmafists: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect(`url('http://${Config.routes.client}/sprites/gen6bgs/bg-earthycave.jpg')`, 2000, 1);
	...
	splinteredstormshards: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect(`url('http://${Config.routes.client}/sprites/gen6bgs/bg-earthycave.jpg')`, 2700, 0.8, 300);
	...
	clangoroussoulblaze: {
		anim(scene, [attacker, ...defenders]) {
			...
			scene.backgroundEffect(`url('http://${Config.routes.client}/sprites/gen6bgs/bg-earthycave.jpg')`, 2000, 0.7, 300);
...
BattleMoveAnims['snaptrap'] = {anim: BattleMoveAnims['bite'].anim};
...
BattleMoveAnims['sappyseed'] = {anim: BattleMoveAnims['seedbomb'].anim};
BattleMoveAnims['freezyfrost'] = {anim: BattleMoveAnims['freezedry'].anim};
BattleMoveAnims['zippyzap'] = {anim: BattleMoveAnims['wildcharge'].anim};
BattleMoveAnims['darkhole'] = {anim: BattleMoveAnims['darkvoid'].anim};
BattleMoveAnims['sonicslash'] = {anim: BattleMoveAnims['aerialace'].anim};
BattleMoveAnims['direclaw'] = {anim: BattleMoveAnims['dragonclaw'].anim};
BattleMoveAnims['stoneaxe'] = {anim: BattleMoveAnims['crosschop'].anim};
BattleMoveAnims['psyshieldbash'] = {anim: BattleMoveAnims['zenheadbutt'].anim};
BattleMoveAnims['ragingfury'] = {anim: BattleMoveAnims['magmastorm'].anim};
BattleMoveAnims['wavecrash'] = {anim: BattleMoveAnims['surf'].anim};
BattleMoveAnims['chloroblast'] = {anim: BattleMoveAnims['solarbeam'].anim};
BattleMoveAnims['mountaingale'] = {anim: BattleMoveAnims['icehammer'].anim};
BattleMoveAnims['victorydance'] = {anim: BattleMoveAnims['quiverdance'].anim};
BattleMoveAnims['headlongrush'] = {anim: BattleMoveAnims['drillrun'].anim};
BattleMoveAnims['barbbarrage'] = {anim: BattleMoveAnims['twineedle'].anim};
BattleMoveAnims['esperwing'] = {anim: BattleMoveAnims['oblivionwing'].anim};
BattleMoveAnims['bittermalice'] = {anim: BattleMoveAnims['acidspray'].anim};
BattleMoveAnims['shelter'] = {anim: BattleMoveAnims['withdraw'].anim};
BattleMoveAnims['triplearrows'] = {anim: BattleMoveAnims['thousandarrows'].anim};
BattleMoveAnims['infernalparade'] = {anim: BattleMoveAnims['psyshock'].anim};
BattleMoveAnims['ceaselessedge'] = {anim: BattleMoveAnims['sacredsword'].anim};
BattleMoveAnims['springtidestorm'] = {anim: BattleMoveAnims['fairywind'].anim};
BattleMoveAnims['bleakwing'] = {anim: BattleMoveAnims['hurricane'].anim};
BattleMoveAnims['wildboltstorm'] = {anim: BattleMoveAnims['thunder'].anim};
BattleMoveAnims['sandsearstorm'] = {anim: BattleMoveAnims['heatwave'].anim};
BattleMoveAnims['lunarblessing'] = {anim: BattleMoveAnims['moonlight'].anim};
BattleMoveAnims['takeheart'] = {anim: BattleMoveAnims['shellsmash'].anim};
BattleMoveAnims['mysticalpower'] = {anim: BattleMoveAnims['psytrike'].anim};