	...
	exports.TeambuilderRoom = exports.Room.extend({
		...
		focus: function () {
			if (this.curTeam) {
				...
				if (this.curTeam.format.includes('rrdl')) {
					this.curTeam.dex = Dex.mod('rr22b');
				}
		...
		canHyperTrain: function (set) {
			...
			if (format.substr(0, 10) === 'battlespot' || format.substr(0, 3) === 'vgc' || format.substr(0, 3) === 'rrc' || format === 'ultrasinnohclassic') {
