...
var _badge=rrBadges[toID(_details2)];
if(_badge){
var _hover=BattleLog.escapeHTML((side.name||'User')+" "+_badge.title);
badgehtml+="<img src=\""+Dex.resourcePrefix+"/sprites/misc/"+_badge.file+"\" style=\"padding: 0px 1px 0px 1px\" width=\"16px\" height=\"16px\" title=\""+_hover+"\" />";
continue;
}
}
...
break;
case 3:
this.bgm=BattleSound.loadBgm('audio/pmd-dialga.mp3',87557,188101,this.bgm);
break;
case 4:
this.bgm=BattleSound.loadBgm('audio/fm-cynthia.mp3',65364,221392,this.bgm);
break;
case 5:
