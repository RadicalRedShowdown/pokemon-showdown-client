(function ($) {
	...
	var AvatarsPopup = this.AvatarsPopup = Popup.extend({
		...
		initialize: function () {
			...
			for (var i = 0; i < avatarList.length; i++) {
				...
				buf += '<button name="setAvatar" value="' + avatar + '" style="background-position:' + offset + '" class="option pixelated' + (avatar === cur ? ' class="cur"' : '') + ' title="/avatar ' + avatar + '"></button>';
			}
	...
	var CustomBackgroundPopup = this.CustomBackgroundPopup = Popup.extend({
		...
		initialize: function () {
			...
			buf += '<button name="setBg" value="houndoom" class="option' + (cur === 'houndoom' ? ' cur' : '') + '"><span class="bg" style="background-position:0 -' + (90 * 0) + 'px"></span>Houndoom</button>';
			buf += '<button name="setBg" value="krookodile" class="option' + (cur === 'krookodile' ? ' cur' : '') + '"><span class="bg" style="background-position:0 -' + (90 * 1) + 'px"></span>Krookodile</button>';
			buf += '<button name="setBg" value="zekrom" class="option' + (cur === 'zekrom' ? ' cur' : '') + '"><span class="bg" style="background-position:0 -' + (90 * 2) + 'px"></span>Zekrom</button>';
			buf += '<button name="setBg" value="typhlosion" class="option' + (cur === 'typhlosion' ? ' cur' : '') + '"><span class="bg" style="background-position:0 -' + (90 * 3) + 'px"></span>Typhlosion</button>';
			buf += '<button name="setBg" value="tapukoko" class="option' + (cur === 'tapukoko' ? ' cur' : '') + '"><span class="bg" style="background-position:0 -' + (90 * 4) + 'px"></span>Tapu Koko</button>';
			buf += '<button name="setBg" value="meganium" class="option' + (cur === 'meganium' ? ' cur' : '') + '"><span class="bg" style="background-position:0 -' + (90 * 5) + 'px"></span>Meganium</button>';
			buf += '<button name="setBg" value="machamp" class="option' + (cur === 'machamp' ? ' cur' : '') + '"><span class="bg" style="background-position:0 -' + (90 * 6) + 'px"></span>Machamp</button>';
			buf += '<button name="setBg" value="ferrothorn" class="option' + (cur === 'ferrothorn' ? ' cur' : '') + '"><span class="bg" style="background-position:0 -' + (90 * 7) + 'px"></span>Ferrothorn</button>';
			buf += '<button name="setBg" value="dialga" class="option' + (cur === 'dialga' ? ' cur' : '') + '"><span class="bg" style="background-position:0 -' + (90 * 8) + 'px"></span>Dialga</button>';
			buf += '<button name="setBg" value="delphox" class="option' + (cur === 'delphox' ? ' cur' : '') + '"><span class="bg" style="background-position:0 -' + (90 * 9) + 'px"></span>Delphox</button>';
			buf += '<button name="setBg" value="delibird" class="option' + (cur === 'delibird' ? ' cur' : '') + '"><span class="bg" style="background-position:0 -' + (90 * 10) + 'px"></span>Delibird</button>';
			buf += '<button name="setBg" value="darkrai" class="option' + (cur === 'darkrai' ? ' cur' : '') + '"><span class="bg" style="background-position:0 -' + (90 * 11) + 'px"></span>Darkrai</button>';
