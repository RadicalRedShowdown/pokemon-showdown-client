...
class BattlesPanel extends PSRoomPanel<BattlesRoom> {
	...
	render() {
		...
		return <PSPanelWrapper room={room} scrollable><div class="pad">
			...
			<div class="roomlist">
				<p>
					<button class="button" name="refresh" onClick={this.refresh}><i class="fa fa-refresh"></i> Refresh</button> <span style={Dex.getPokemonIcon('houndoom-mega') + ';display:inline-block;vertical-align:middle'} class="picon" title="Houndoom is Radical Red's mascot!"></span>
				</p>
